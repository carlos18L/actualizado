...
<div class="section-header mt-3">
    <h3 class="text-white jjjj">Bienvenido al Sistema de Tutorías del ITSTE</h3>
</div>
    ...
    @if(\Illuminate\Support\Facades\Auth::user())
        <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="{{ asset('img/loginIcon.avif') }}" class="rounded-circle mr-1 thumbnail-rounded user-thumbnail ">
